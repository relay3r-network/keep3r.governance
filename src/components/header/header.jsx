  ...
  renderAccountInformation = () => {
    ...
    return (
      <div className={ classes.accountDetailsSection }>
        <img  className={ classes.accountDetailsAddress } src= {require("../../assets/eth-logo.png")} alt="network" width={ parseInt(store.getStore("chainId")) === 1 ? "46px" : "55px"} height="30px"></img>
