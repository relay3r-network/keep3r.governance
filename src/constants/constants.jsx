...
export const CHAIN_ID_RETURNED = 'CHAIN_ID_RETURNED'
...
export const SWAP_APPROVE = 'SWAP_APPROVE'
export const SWAP_APPROVED = 'SWAP_APPROVED'
export const SWAP_APPROVE_RETURNED = 'SWAP_APPROVE_RETURNED'
export const SWAP_EXECUTE = 'SWAP_EXECUTE'
export const SWAP_EXECUTE_RETURNED = 'SWAP_EXECUTE_RETURNED'

export const TRANSFER_RIGHTS = 'TRANSFER_RIGHTS'
export const TRANSFER_RIGHTS_RETURNED = 'TRANSFER_RIGHTS_RETURNED'

export const ADD_CREDITS = 'ADD_CREDITS';
export const ADD_CREDITS_RETURNED = 'ADD_CREDITS_RETURNED';

export const GET_GOVERNANCE_ADDRESS = 'GET_GOVERNANCE_ADDRESS';
export const GET_GOVERNANCE_ADDRESS_RETURNED = 'GET_GOVERNANCE_RETURNED';
